async function isbnAssist(isbn) {
    ...
    let values = [document.getElementById("title").value = title, 
                    document.getElementById("pub-year").value = pubYear, 
                    document.getElementById("publisher").value = publisher,
                    document.getElementById("isbn").value = isbn,
                    document.getElementById("cover").value = coverURL,
                    document.getElementById("summary").value = summary,
                    document.getElementById("author-first-name").value = authorFirstName,
                    document.getElementById("author-surname").value = authorSurname,
                    document.getElementById("author-birth-year").value = authorBirthYear,
                    document.getElementById("author-death-year").value = authorDeathYear,
                ]
